...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider :aws do |aws, override|
    ...
    aws.keypair_name = "sahan-assignment2"
    # The private_key_path is a file location in your macOS account
    # (e.g., ~/.ssh/something).
    override.ssh.private_key_path = "~/.ssh/sahan-assignment2.pem"
    ...
    # square brackets.
    #
    aws.security_groups = ["sg-04171e85323d7d2c2","sg-07f4130f878caed3c"]
    ...
    aws.subnet_id = "subnet-007be2e01a5b4f8ee" #"subnet-095d5b18d035c1fe2"
